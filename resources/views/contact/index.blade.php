...
<div class="container mx-auto px-10 py-10 bg-blue-50 rounded-lg shadow-lg">
    ...
    <form method="POST" action="{{ route('contact.confirm') }}">
        ...
        <div class="mb-8">
            ...
            <textarea name="content" id="content" class="mt-1 block w-full py-5 rounded-md border-gray-300 shadow-sm"  placeholder="　例）お問い合わせの内容をご入力ください。">{{ old('content') }}</textarea>
